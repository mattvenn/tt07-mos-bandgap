...
C {devices/lab_wire.sym} -290 380 0 0 {name=p6 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 30 380 0 1 {name=p7 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 190 380 0 1 {name=p8 sig_type=std_logic lab=VSS}
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/bandgap-op-dtmos.raw dc"
}
...
* temp sweep while changing a value
if (do_loop_temp)
  let bot_m_w_val = 2
  repeat 20
